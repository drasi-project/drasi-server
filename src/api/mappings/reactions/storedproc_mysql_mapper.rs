...
//! MySQL stored procedure reaction configuration mapper.
...
use drasi_reaction_storedproc_mysql::MySqlStoredProcReactionConfig;
use std::collections::HashMap;

pub struct MySqlStoredProcReactionConfigMapper;

impl ConfigMapper<MysqlStoredProcReactionConfigDto, MySqlStoredProcReactionConfig>
    for MySqlStoredProcReactionConfigMapper
{
    fn map(
        &self,
        dto: &MysqlStoredProcReactionConfigDto,
        resolver: &DtoMapper,
    ) -> Result<MySqlStoredProcReactionConfig, MappingError> {
        ...
        Ok(MySqlStoredProcReactionConfig {
            hostname,
            port,
            user,
            password,
