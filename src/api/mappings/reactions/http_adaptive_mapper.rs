...
impl ConfigMapper<HttpAdaptiveReactionConfigDto, HttpAdaptiveReactionConfig> for HttpAdaptiveReactionConfigMapper {
    fn map(&self, dto: &HttpAdaptiveReactionConfigDto, resolver: &DtoMapper) -> Result<HttpAdaptiveReactionConfig, MappingError> {
