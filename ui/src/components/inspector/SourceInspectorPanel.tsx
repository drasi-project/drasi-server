      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <ActionButtons
            ...
            onStop={onStop}
            onDelete={onDelete}
            deleteDisabled={queries.length > 0}
            deleteDisabledReason={queries.length > 0 ? `Cannot delete: ${queries.length} query(s) depend on this source` : undefined}
            compact
          />
        </div>
      </div>
